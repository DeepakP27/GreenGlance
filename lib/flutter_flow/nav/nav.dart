...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ClosestRecycling',
          path: '/closestRecycling',
          builder: (context, params) => const ClosestRecyclingWidget(),
        ),
        FFRoute(
          name: 'ChatBot',
          path: '/chatBot',
        ...
        FFRoute(
          name: 'ClosestRecyclingCopy',
          path: '/closestRecyclingCopy',
          builder: (context, params) => const ClosestRecyclingCopyWidget(),
        )
